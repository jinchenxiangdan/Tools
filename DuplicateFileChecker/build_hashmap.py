...
MY_HASH_TABLE_1_FILE_PATH       = OUT_DIRECTORY + "/" + "MY_HASHTABLE_1.data"   # checksum -> filename
MY_HASH_TABLE_2_FILE_PATH       = OUT_DIRECTORY + "/" + "MY_HASHTABLE_2.data"   # filename -> path
